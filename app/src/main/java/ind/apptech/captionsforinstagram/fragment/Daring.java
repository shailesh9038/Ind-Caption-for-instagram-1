...
public class Daring extends Fragment {
    ...
    public static Daring newInstance(String param1, String param2) {
        Daring fragment = new Daring();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        englist.add("If a boy can play guitar, it makes him that much more attractive.");
        ...
        englist.add("Knowledge is knowing a tomato is a fruit. Wisdom is not putting it in a fruit salad.");
